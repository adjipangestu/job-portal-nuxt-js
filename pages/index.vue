...
export default Vue.extend({
  head () {
    return {
      title: 'Career Kumis',
      meta: [
        { hid: 'og-title', property: 'og:title', content: 'Career' },
        { hid: 'description', name: 'description', content: 'Temukan pekerjaan yang sesuai dengan kemampuan dan keinginan anda.' },
        // other meta
      ]
    }
  },
